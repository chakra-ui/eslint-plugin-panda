...
🌐 Set in the `plugin:@pandacss/all` configuration.\
✅ Set in the `plugin:@pandacss/recommended` configuration.\
...
| [no-property-renaming](plugin/docs/rules/no-property-renaming.md)                 | Ensure user does not rename a property for a pattern or style prop. It doesn't get tracked.                                                    |       | 🌐 ✅ |     |
